        ...
        if st.button("Run Prediction"):
            if file_path:
                try:
                    ...
                    st.markdown(f"<div class='top-brand-models'>Top Brand: <b>{top_brand.index[0]}</b></div>", unsafe_allow_html=True)
                    ...
                    with st.expander("Trend with Age of Car"):
                        ...
                        with col1:
                            ...
                            fig, ax = plt.subplots()
                            sns.barplot(x='age_of_car', y='price', data=grouped_by_age, ax=ax, label='Actual Price', color='skyblue')
                        ...
                        with col2:
                            # Trend with Age of Car with Price
                            fig, ax = plt.subplots()
                            sns.barplot(x='age_of_car', y='predictions', data=grouped_by_age, ax=ax, label='Predicted Price', color='lightgreen')
